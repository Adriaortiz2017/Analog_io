...
void loop()
{
 ...
 Serial.println (valLdr2);
  ...
  valLdr0 = map(valLdr0, 0, 1000, 0, 255);   // mapejar valor de 0-1023 a 0-255
  valLdr1 = map(valLdr1, 0, 1000, 0, 255);   // mapejar valor de 0-1023 a 0-255
  valLdr2 = map(valLdr2, 0, 1000, 0, 255);   // mapejar valor de 0-1023 a 0-255
